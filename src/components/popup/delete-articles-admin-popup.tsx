...
export default function DeleteArticlesAdminPopup() {
    return (
        <div className="fixed flex items-center justify-center w-full h-screen z-20">
            ...
            <div className="absolute flex flex-col items-start justify-center w-[450px] h-[200px] px-6 bg-white rounded-lg">
                ...
                <div className="flex flex-row w-full items-center justify-end gap-2">
                    ...
                    <div className="flex items-center justify-center w-[100px] h-[40px] bg-[#DC2626] text-white border rounded-md cursor-pointer">Logout</div>
                </div>
            </div>
