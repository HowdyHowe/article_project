    ...
    return (
        <div className="flex flex-col items-center justify-evenly w-[95%] h-[525px] bg-white rounded-xl lg:w-[500px] lg:h-[500px]">
            ...
            <form className="flex flex-col w-[90%]">
                ...
                <input type="text" className="w-full h-[50px] px-3 border-[2px] rounded-lg placeholder:text-[#64748B] focus:outline-none focus:ring-0 resize-none" placeholder="Input Username"/>
                ...
                <div className="flex flex-row items-center w-full h-[50px] border-[2px] rounded-lg">
                    <input type={visible ? "text": "password"} className="w-full h-full px-3 bg-transparent placeholder:text-[#64748B] focus:outline-none focus:ring-0 resize-none" placeholder="Input Password"/>
